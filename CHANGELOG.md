...
### Added
- **Release notes for 0.5.15**: added a detailed summary page covering runtime visibility, Discord supervisor mode, Microsoft email OAuth, mailbox hardening, external skill imports, and the related Devices/Inbox UX updates. See [Release Notes 0.5.15](docs/release-notes-0.5.15.md).
