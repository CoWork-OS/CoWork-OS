...
| GitHub forks | 79 | n/a |
| Installer/server downloads | 1,741 | 1,741 |
| Download delta | +3 | n/a |
| npm downloads | 250 (last week) | 8,195 |
| GitHub views, last 14-ish days | 1,688 total / 588 unique | n/a |
| GitHub clones, last 14-ish days | 11,680 total / 495 unique | n/a |

Generated 2026-09-19T08:00:40.368Z. These are public GitHub/npm adoption signals, not active-user or in-app telemetry numbers. All-time values are shown only where the source API provides lifetime coverage. [Full report](docs/public-adoption-stats.md).
