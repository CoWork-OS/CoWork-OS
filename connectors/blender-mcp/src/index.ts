...
function projectRoot(): string {
  ...
  if (!raw.trim()) {
    throw new Error(
      "COWORK_ARCH_PROJECT_ROOT or COWORK_WORKSPACE_ROOT is required for Blender file path tools.",
    );
  }
...
const tools: MCPTool[] = [
  {
    name: "blender.health",
    description: "Check Blender bridge availability",
    inputSchema: { type: "object", properties: {}, additionalProperties: false },
  },
  {
    name: "blender.open_scene",
    description: "Open an existing Blender scene",
    inputSchema: {
      type: "object",
  ...
  },
  {
    ...
    description: "Create a new Blender scene for an architecture project",
    inputSchema: {
      type: "object",
      properties: { projectId: { type: "string" }, scenePath: { type: "string" } },
      required: ["projectId", "scenePath"],
      additionalProperties: false,
    },
  },
  {
    name: "blender.import_model",
    description: "Import a Rhino-exported model into Blender",
    inputSchema: {
      type: "object",
      properties: {
        projectId: { type: "string" },
        modelPath: { type: "string" },
        preserveLayers: { type: "boolean", default: true },
      },
      required: ["projectId", "modelPath"],
      additionalProperties: false,
    },
  },
  {
    name: "blender.assign_materials_by_layer",
    description: "Assign Blender materials using layer/object names",
    inputSchema: {
      type: "object",
      properties: {
        projectId: { type: "string" },
        materialMap: objectSchema("Layer or object name to material definition map"),
      },
      required: ["projectId", "materialMap"],
      additionalProperties: false,
    },
  },
  {
    name: "blender.create_material",
    description: "Create or update one Blender material",
    inputSchema: {
      type: "object",
      properties: {
        projectId: { type: "string" },
        name: { type: "string" },
        material: objectSchema("Material properties"),
      },
      required: ["projectId", "name", "material"],
      additionalProperties: false,
    },
  },
  {
    name: "blender.setup_camera",
    description: "Create or update a render camera",
    inputSchema: {
      type: "object",
      properties: {
        projectId: { type: "string" },
        camera: objectSchema("Camera transform/lens settings"),
      },
      required: ["projectId", "camera"],
      additionalProperties: false,
    },
  },
  {
    name: "blender.setup_lighting",
    description: "Create or update scene lighting",
    inputSchema: {
      type: "object",
      properties: { projectId: { type: "string" }, lighting: objectSchema("Lighting setup") },
      required: ["projectId", "lighting"],
      additionalProperties: false,
    },
  },
  {
    name: "blender.set_render_engine",
    description: "Set render engine and quality options",
    inputSchema: {
      type: "object",
      properties: {
        projectId: { type: "string" },
  ...
  {
    name: "blender.render_view",
    description: "Render a camera view to an image",
    inputSchema: {
      type: "object",
      properties: {
        projectId: { type: "string" },
  ...
  },
  {
    ...
    description: "Capture the current Blender viewport",
    inputSchema: {
      type: "object",
  ...
  {
    name: "blender.save_scene",
    description: "Save the active Blender scene",
    inputSchema: {
      type: "object",
