...
Generated at: 2026-07-22T06:03:45.024Z
...
| Installer/server downloads, lifetime | 1,299 |
| Installer/server downloads, since previous snapshot | 7 |
| npm latest version | 0.5.50 |
| npm downloads, last day | 194 |
| npm downloads, last week | 255 |
| npm downloads, last month | 694 |
| GitHub views, last 14-ish days | 1,205 total / 515 unique |
| GitHub clones, last 14-ish days | 23,237 total / 596 unique |
...
|---|---|---|---:|---:|
| v0.5.50 | CoWork-OS-0.5.50-arm64-mac.zip | macos | 2 | +1 |
| v0.5.50 | CoWork-OS-0.5.50-arm64.dmg | macos | 1 | +1 |
| v0.5.50 | cowork-os-server-linux-x64-v0.5.50.tar.gz | server | 1 | +1 |
| v0.5.50 | CoWork-OS-Setup-0.5.50.exe | windows | 8 | +4 |
...
| 9 | perplexity.ai | 2 | 2 |
| 10 | teams.public.onecdn.static.microsoft | 2 | 1 |

## Top GitHub Paths

| Rank | Item | Count | Uniques |
|---:|---|---:|---:|
| 1 | /cowork-os/cowork-os | 280 | 216 |
| 2 | /CoWork-OS/CoWork-OS | 278 | 208 |
| 3 | /CoWork-OS/CoWork-OS/blob/main/resources/branding/images/cowork-os-1.webp | 67 | 44 |
| 4 | /CoWork-OS/CoWork-OS/releases/tag/v0.5.49 | 34 | 29 |
| 5 | /CoWork-OS/CoWork-OS/tree/main | 29 | 19 |
| 6 | /CoWork-OS/CoWork-OS/tree/main/resources/skills/taste-skill | 26 | 21 |
| 7 | /CoWork-OS/CoWork-OS/releases | 24 | 18 |
| 8 | /CoWork-OS/CoWork-OS/issues | 24 | 14 |
| 9 | /CoWork-OS/CoWork-OS/blob/main/resources/branding/images/cowork-os-7.webp | 19 | 8 |
| 10 | /CoWork-OS/CoWork-OS/blob/main/resources/branding/images/cowork-os-4.webp | 17 | 15 |
