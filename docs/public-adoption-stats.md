...
Generated at: 2026-07-16T05:48:23.627Z
...
| Installer/server downloads, lifetime | 1,254 |
| Installer/server downloads, since previous snapshot | 7 |
| npm latest version | 0.5.49 |
| npm downloads, last day | 6 |
| npm downloads, last week | 178 |
| npm downloads, last month | 548 |
| GitHub views, last 14-ish days | 1,322 total / 591 unique |
| GitHub clones, last 14-ish days | 10,592 total / 585 unique |
...
| v0.5.49 | CoWork-OS-0.5.49-arm64.dmg | macos | 57 | +1 |
| v0.5.49 | cowork-os-server-linux-x64-v0.5.49.tar.gz | server | 14 | +1 |
| v0.5.49 | CoWork-OS-Setup-0.5.49.exe | windows | 125 | +5 |
...
| Rank | Item | Count | Uniques |
|---:|---|---:|---:|
| 1 | /cowork-os/cowork-os | 341 | 252 |
| 2 | /CoWork-OS/CoWork-OS | 277 | 205 |
| 3 | /CoWork-OS/CoWork-OS/blob/main/resources/branding/images/cowork-os-1.webp | 72 | 43 |
| 4 | /CoWork-OS/CoWork-OS/releases/tag/v0.5.49 | 42 | 38 |
| 5 | /CoWork-OS/CoWork-OS/tree/main/resources/skills/taste-skill | 39 | 30 |
| 6 | /CoWork-OS/CoWork-OS/blob/main/docs/getting-started.md | 28 | 11 |
| 7 | /CoWork-OS/CoWork-OS/pulls | 26 | 16 |
| 8 | /CoWork-OS/CoWork-OS/issues | 24 | 16 |
| 9 | /CoWork-OS/CoWork-OS/tree/main | 22 | 19 |
| 10 | /CoWork-OS/CoWork-OS/releases | 21 | 14 |
