...
FANOUT_THRESHOLD = 8          # above this many unscanned brokers, use CoWork subagent fan-out
    ...
    if unscanned:
        ...
        if len(ids) > FANOUT_THRESHOLD:
            actions.append({
                ...
                "how": "spawn ONE CoWork subagent per batch IN PARALLEL with each batch's brief; "
