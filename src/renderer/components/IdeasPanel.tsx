...
const SECTION_LABELS = Object.fromEntries(CATEGORIES.map((c) => [c.id, c.label])) as Record<
  IdeaCategory,
  string
>;
...
const IDEAS: Idea[] = [
  ...
  },
  {
    ...
    prompt:
      "Use the stock-analysis skill. I'll give you a ticker. Fetch real-time quote, fundamentals (P/E, EPS, margins), technical indicators, and analyst sentiment. Summarise with a buy / hold / sell recommendation.",
    icon: TrendingUp,
    category: "finance",
  ...
  // ── Research ───────────────────────────────────────────────────────
  {
    ...
    prompt:
      "Use the competitive-research skill. I'll describe the market. Research the top 3–5 competitors: positioning, features, pricing, strengths, weaknesses. Identify differentiation gaps I could exploit.",
    icon: Globe,
    category: "research",
              ...
              return (
                ...
                >
                  ...
                  <div className="dp-task-meta dp-idea-meta">
                    ...
                    {idea.skill && <span className="dp-purpose-chip subtle">{idea.skill}</span>}
                  </div>
                </button>
              );
            })}
