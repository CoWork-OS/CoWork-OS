...
type ResizableDividerHandleProps = HTMLAttributes<HTMLDivElement> & {
  orientation?: "vertical" | "horizontal";
};

export function ResizableDividerHandle({
  ...
  return (
    <div
      ...
      className={["app-resizable-divider", `app-resizable-divider--${orientation}`, className]
        ...
        .join(" ")}
      {...props}
      style={{ flex: "0 0 auto", touchAction: "none", ...style }}
    >
      {children ?? (
        <div className="app-resizable-divider-grip" aria-hidden="true">
          <svg
            className="app-resizable-divider-icon"
            viewBox="0 0 24 24"
