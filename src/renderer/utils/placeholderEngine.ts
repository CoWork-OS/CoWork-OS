...
const POOL: TaggedPlaceholder[] = [
  ...
  { text: "Map the customer journey from signup to first value", personas: ["marketing", "product"] },
  ...
  { text: "Create a go-to-market checklist for the beta launch", personas: ["product", "marketing"] },
  ...
  { text: "Draft an SOP for the incident response process", personas: ["operations", "engineering"] },
  ...
  { text: "Write a compelling listing description for this home", personas: ["realestate", "writing"] },
  { text: "Build a rent-vs-buy calculator with my numbers", personas: ["realestate", "trading"] },
  { text: "Draft a market update newsletter for my clients", personas: ["realestate", "marketing"] },

  // ── Creative & media ──────────────────────────────────────────────────
  { text: "Write a video script for a 2-minute product explainer", personas: ["creative", "marketing"] },
...
const SIGNAL_KEYWORDS: Record<Persona, string[]> = {
  universal: [],
  engineering: [
    "code", "bug", "deploy", "api", "test", "ci", "cd", "git", "docker",
    "kubernetes", "backend", "frontend", "database", "schema", "migration",
    "refactor", "debug", "lint", "build", "compile", "repo", "pull request",
    "merge", "branch", "typescript", "python", "rust", "java", "devops",
    "infrastructure", "server", "endpoint", "sdk", "cli", "webpack", "npm",
  ],
  trading: [
    "stock", "trade", "portfolio", "market", "earnings", "dividend", "option",
    "equity", "bond", "etf", "crypto", "bitcoin", "forex", "hedge", "short",
    "long", "bull", "bear", "dcf", "valuation", "p/e", "revenue", "sec",
    "10-k", "10-q", "filing", "ticker", "sharpe", "alpha", "beta",
    "backtest", "ipo", "yield", "fed", "interest rate", "balance sheet",
  ],
  education: [
    "lesson", "student", "teach", "curriculum", "syllabus", "grade",
    "rubric", "assignment", "quiz", "exam", "lecture", "course", "class",
    "tutor", "learn", "homework", "flashcard", "study", "school",
    "university", "professor", "pedagogy", "lms", "canvas", "moodle",
  ],
  marketing: [
    "campaign", "seo", "sem", "ctr", "conversion", "funnel", "lead",
    "content", "brand", "social media", "ad copy", "email marketing",
    "newsletter", "audience", "engagement", "influencer", "analytics",
    "impression", "reach", "cpc", "roas", "retention", "churn",
    "landing page", "a/b test", "copy", "growth", "acquisition",
  ],
  design: [
    "figma", "sketch", "wireframe", "mockup", "prototype", "ui", "ux",
    "typography", "color palette", "spacing", "component", "design system",
    "accessibility", "wcag", "responsive", "layout", "icon", "illustration",
    "animation", "interaction", "user flow", "persona",
  ],
  product: [
    "prd", "roadmap", "backlog", "sprint", "user story", "feature",
    "prioritize", "okr", "kpi", "metric", "launch", "release", "beta",
    "mvp", "product-market fit", "user research", "feedback", "nps",
    "onboarding", "adoption", "retention", "activation",
  ],
  founder: [
    "startup", "investor", "pitch", "fundraise", "seed", "series a",
    "venture", "cap table", "term sheet", "burn rate", "runway",
    "board", "co-founder", "pivot", "tam", "sam", "som", "incorporation",
    "equity", "dilution", "valuation", "accelerator", "yc",
  ],
  sales: [
    "prospect", "pipeline", "deal", "close", "quota", "crm", "salesforce",
    "hubspot", "demo", "proposal", "rfp", "objection", "negotiation",
    "account", "territory", "commission", "outreach", "cold email",
    "discovery call", "champion", "decision maker",
  ],
  hr: [
    "hire", "recruit", "candidate", "interview", "offer", "onboarding",
    "performance review", "compensation", "benefits", "culture", "policy",
    "employee", "headcount", "attrition", "engagement survey", "dei",
    "job description", "pto", "payroll",
  ],
  legal: [
    "contract", "clause", "liability", "compliance", "gdpr", "hipaa",
    "terms of service", "privacy policy", "nda", "ip", "patent",
    "trademark", "copyright", "regulation", "dispute", "litigation",
    "amendment", "indemnity", "license", "agreement",
  ],
  data: [
    "sql", "query", "dashboard", "etl", "pipeline", "warehouse",
    "visualization", "tableau", "power bi", "looker", "dbt", "bigquery",
    "snowflake", "redshift", "pandas", "jupyter", "notebook", "csv",
    "metric", "kpi", "anomaly", "regression", "forecast",
  ],
  research: [
    "paper", "study", "hypothesis", "experiment", "methodology", "peer review",
    "citation", "abstract", "journal", "conference", "literature review",
    "bibliography", "thesis", "dissertation", "grant", "arxiv", "pubmed",
    "meta-analysis", "sample size", "control group",
  ],
  operations: [
    "sop", "process", "supply chain", "logistics", "vendor", "procurement",
    "inventory", "warehouse", "fulfillment", "capacity", "incident",
    "runbook", "escalation", "sla", "downtime", "postmortem",
    "risk register", "continuity",
  ],
  support: [
    "ticket", "support", "helpdesk", "knowledge base", "faq", "escalation",
    "sla", "csat", "nps", "response time", "resolution", "zendesk",
    "intercom", "freshdesk", "triage", "queue", "macro",
  ],
  personal: [
    "travel", "trip", "itinerary", "recipe", "meal plan", "budget",
    "fitness", "habit", "journal", "goal", "hobby", "reading list",
    "move", "apartment", "wedding", "vacation", "grocery",
  ],
  healthcare: [
    "patient", "clinical", "diagnosis", "treatment", "care plan",
    "medical", "health", "ehr", "fhir", "hipaa", "pharmacy",
    "prescription", "symptom", "lab result", "vitals", "icd",
    "procedure", "triage", "referral",
  ],
  realestate: [
    "property", "listing", "mortgage", "appraisal", "closing",
    "inspection", "mls", "comps", "zoning", "escrow", "hoa",
    "rental", "lease", "tenant", "landlord", "cap rate",
  ],
  creative: [
    "video", "podcast", "script", "storyboard", "animation",
    "film", "edit", "shoot", "production", "post-production",
    "music", "audio", "voiceover", "thumbnail", "youtube", "tiktok",
    "instagram", "reel",
  ],
  writing: [
    "blog", "article", "essay", "draft", "copy", "edit", "proofread",
    "tone", "voice", "headline", "outline", "chapter", "manuscript",
    "publish", "medium", "substack", "ghostwrite",
  ],
};
...
export function buildPlaceholders(
  ...
  if (!hasSignal) {
    const universal = POOL
      .filter((p) => p.personas.includes("universal"))
      .map((p) => p.text);
    // Add plugin prompts
