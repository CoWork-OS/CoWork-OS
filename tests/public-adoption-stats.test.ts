...
const { buildNpmAllTimeMetric, getNpmFirstPublishedDay, sumNpmDownloadRows } =
  await import("../scripts/public-adoption-stats-utils.mjs");
    ...
    expect(
      getNpmFirstPublishedDay({
        time: {
          ...
          "0.5.1": "2026-02-05T00:00:00Z",
          "0.5.0": "2026-02-01T00:00:00Z",
        },
      }),
    ).toBe("2026-02-01");
    expect(sumNpmDownloadRows([{ downloads: 5 }, { downloads: null }, {}, { downloads: 3 }])).toBe(
      8,
    );
  });
});
